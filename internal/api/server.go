...
func (s *Server) RegisterRoutes(mux *http.ServeMux) {
	...
	// store the returned lununda user_id locally.
...
func (s *Server) handleCORS(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Access-Control-Allow-Headers", "Authorization, Content-Type, x-lununda-agent-id, x-lununda-session-key")
