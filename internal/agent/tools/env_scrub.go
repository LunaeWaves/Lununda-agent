...
// subprocesses. LUNUNDA_STORAGE_* and LUNUNDA_OBJECT_STORE_* carry
// the daemon's DSN + object-store credentials; LUNUNDA_SANDBOX_BOXLITE_*
// carries the sandbox provider's apikey. The model has no business
// reading any of these.
var sensitiveEnvPrefixes = []string{
	"LUNUNDA_STORAGE_",
	"LUNUNDA_OBJECT_STORE_",
	"LUNUNDA_SANDBOX_BOXLITE_",
	"AWS_",
