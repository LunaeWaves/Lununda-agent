...
//   - cookie session ("lununda_session"): set by /api/login, validated
...
const SessionCookieName = "lununda_session"
...
// middleware will lazily mint (or look up) a lununda user for
