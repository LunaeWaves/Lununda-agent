...
const (
	...
	// MethodChatSend: plugin → lununda notification that delivers a
...
// must not cache credentials — Lununda Agent re-sends them every call so any
...
// ChatSendParams: plugin → lununda push of an outbound message to a
