#!/usr/bin/env bash
# Build the lununda-sandbox runtime image used by the agent's exec
...
# Image, or during onboard. Default: ghcr.io/lunaewaves/lununda-sandbox:latest.
...
IMAGE_NAME=${IMAGE_NAME:-ghcr.io/lunaewaves/lununda-sandbox}
TAG=latest
PUSH=0
PLATFORM=""
