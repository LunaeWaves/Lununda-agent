---
name: lununda-skill-learner
description: Analyze conversations to extract reusable skill patterns. Used internally by Lununda Agent to auto-generate skills from complex multi-step tasks.
metadata:
  lununda:
    always: true
---
