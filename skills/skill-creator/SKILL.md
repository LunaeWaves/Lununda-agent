...
## Lununda Agent runtime — read this first

This skill is invoked from a Lununda Agent agent. The host runtime has its
...
disk (`~/.lununda/users/<userId>/skills/<name>/`). SkillsLoader scans
...
etc. On Lununda Agent, ignore those file-layout details: the only thing
