...
const UPGRADE_CMD = "lununda upgrade";

const RELEASES_URL = "https://github.com/LunaeWaves/Lununda-agent/releases";
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-border bg-card p-5 space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-sm text-muted-foreground">Lununda Agent</span>
