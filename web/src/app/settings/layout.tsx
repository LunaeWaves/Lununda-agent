...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  const items = [
    { href: "/settings/general", label: t("settings.general"), adminOnly: false },
    { href: "/settings/account", label: t("settings.account"), adminOnly: false },
    { href: "/settings/about", label: t("settings.about"), adminOnly: false },
    { href: "/settings/runtime", label: t("settings.runtimeNav"), adminOnly: true },
  ];
  ...
  return (
    <div className="flex flex-col md:flex-row md:gap-8 p-4 md:p-6 max-w-6xl mx-auto md:min-h-[calc(100vh-3.5rem)]">
      <aside className="md:w-48 md:shrink-0 mb-4 md:mb-0">
        <h2 className="text-lg font-semibold tracking-tight mb-3 md:mb-4">{t("settings.layoutTitle")}</h2>
